...
# printing out the strings in the given array in alphabetical order
# they should be each on a separate line

# using python
# sort the array by ascending order
# printin them on a separate line
...
# printing out the strings in the given array sorted by the middle letters
# they should be each on a separate line

# using python
# sort the array by middle letters of each string
# printing them on a separate line

array2 = ['Waltz', 'Tango', 'Viennese Waltz', 'Foxtrot', 'Cha Cha', 'Samba', 'Rumba', 'Paso Doble', 'Jive']

array2.sort(key= lambda word: word[len(word)//2])
